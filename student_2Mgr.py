...
# CSS – omezení šířky vstupních polí (stejné jako u 1. Mgr.)
st.markdown("""
<style>
...
# Výchozí struktura pro 2. Mgr. – Úprava: letní semestr má druhý řádek jako "Zkouška" místo "Zápočet 2"
...
def run_student():
    ...
    ### Levý sloupec – Zimní semestr: Speciální TP-2
    with col_left:
        ...
        with st.expander("Detail hodnocení", expanded=True):
            ...
            # Řádek 1: Kurz BZ-IV (checkbox, checkbox Instruktor, textové pole pro Učitele)
            ...
            # Řádek 2: Kurz VL-IV (checkbox, checkbox Instruktor, textové pole pro Učitele)
            ...
            # Řádek 3: Kurz PSL-II (checkbox, checkbox Instruktor, textové pole pro Učitele)
            ...
            # Řádek 4: Klasifikovaný zápočet (checkbox, textové pole pro Známku, textové pole pro Učitele)
            ...
            # Řádek 5: Vyhodnocení Splněno podle podmínek
    ...
    ### Pravý sloupec – Letní semestr: Teorie a didaktika AČR-3
    with col_right:
        ...
        with st.expander("Detail hodnocení", expanded=True):
            ...
            # Řádek 1: Zápočet 1 (checkbox a textové pole pro Učitele)
            ...
            # Řádek 2: Zkouška (checkbox, textové pole pro Známku, textové pole pro Učitele)
            ...
            # Řádek 3: Vyhodnocení Splněno podle podmínek – Splněno je, když jsou dokončeny obě položky: Zápočet 1 i Zkouška
